...
import wtf.expensive.modules.impl.combat.KeepSprintModule;
            ...
            if (!targetEntity.hitByEntity(this)) {
                ...
                if (f > 0.0F || f1 > 0.0F) {
                    ...
                    if (flag5) {
                        ...
                        if (Expensive.getInstance().getModuleManager().get(KeepSprintModule.class).state) {
                            this.motionX *= 1.D;
                            this.motionZ *= 1.D;
    ...
    public float getEyeHeight() {
        ...
        if (this.isPlayerSleeping()) {
            ...
            if (this.isElytraFlying() || this.height == 0.6F) {
                if (Expensive.getInstance().getModuleManager().get(ElytraFly.class).state) {
                    f = 1.62F;
                } else {
                    f = 0.4F;
                }
