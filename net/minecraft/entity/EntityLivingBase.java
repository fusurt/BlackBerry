...
public abstract class EntityLivingBase extends Entity {
    ...
    private int getArmSwingAnimationEnd() {
        if (Expensive.getInstance().getModuleManager().get(SwingAnimationModule.class).state && this instanceof EntityPlayerSP) {
            int speed = (int) SwingAnimationModule.swipeSpeed.get();
    ...
    public boolean canBePushed() {
        if (Expensive.getInstance().getModuleManager().get(NoPush.class).state
                && this instanceof EntityPlayerSP) return false;
