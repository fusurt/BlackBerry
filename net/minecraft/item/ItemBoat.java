...
public class ItemBoat extends Item
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World itemStackIn, EntityPlayer worldIn, EnumHand playerIn)
    {
        ...
        else
        {
            ...
            boolean flag = false;
            List<Entity> list = itemStackIn.getEntitiesWithinAABBExcludingEntity(worldIn, worldIn.getEntityBoundingBox().addCoord(vec3d2.x * 5.0D, vec3d2.y * 5.0D, vec3d2.z * 5.0D).expandXyz(1.0D));
            ...
            else
            {
                ...
                EntityBoat entityboat = new EntityBoat(itemStackIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
