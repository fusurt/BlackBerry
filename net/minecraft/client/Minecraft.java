...
import wtf.expensive.event.impl.game.EventCloseGame;
...
import wtf.expensive.modules.impl.util.AntiThrowBlock;
import wtf.expensive.styles.StyleConfig;
import wtf.expensive.utility.drag.DragManager;
import wtf.expensive.utility.util.DiscordHelper;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public int getLimitFramerate() {
        ...
        return this.world == null && this.currentScreen != null ? 360 : this.gameSettings.limitFramerate;
    }
    ...
    public void shutdown() {
        EventManager.dispatchEvent(new EventCloseGame());
        try {
        ...
        if (this.leftClickCounter <= 0) {
            if (this.objectMouseOver == null) {
                ...
                switch (this.objectMouseOver.typeOfHit) {
                    ...
                    case MISS:
                        if (Expensive.getInstance().getModuleManager().backTrackModule.pointed() != null
                                && Expensive.getInstance().getModuleManager().backTrackModule.state) {
                            this.playerController.attackEntity(this.player, Expensive.getInstance().getModuleManager().backTrackModule.pointed());
                        }
                        if (this.playerController.isNotCreative()) {
                            this.leftClickCounter = 10;
                        }
        ...
        if (!this.playerController.getIsHittingBlock()) {
            ...
            if (!this.player.isRowingBoat()) {
                ...
                for (EnumHand enumhand : EnumHand.values()) {
                    ...
                    EventRightClick erc = new EventRightClick();
                    EventManager.dispatchEvent(erc);
                    if (itemstack.getItem() instanceof ItemAppleGold && erc.isCancelled()) {
                        break;
                    }
                    ...
                    if (this.objectMouseOver != null) {
                        switch (this.objectMouseOver.typeOfHit) {
                            case ENTITY -> {
                                EventInteractEntity eiwe = new EventInteractEntity(this.objectMouseOver.entityHit);
                                EventManager.dispatchEvent(eiwe);
                                if (!eiwe.isCancelled()) {
                            ...
                            case BLOCK -> {
                                ...
                                if (Expensive.getInstance().getModuleManager().get(NoInteractModule.class).state &&
                                        NoInteractModule.allBlocks.get()) {
                                    break;
                                }

                                if (Expensive.getInstance().getModuleManager().get(NoInteractModule.class).state &&
                                        NoInteractModule.getBlocks().contains(this.world.getBlockState(blockpos).getBlock())) {
                                    break;
                                }
                                ...
                                if (this.world.getBlockState(blockpos).getMaterial() != Material.AIR) {
                                    ...
                                    if (enumactionresult == EnumActionResult.SUCCESS) {
                                        ...
                                        if (!itemstack.isEmpty() && (itemstack.func_190916_E() != i || this.playerController.isInCreativeMode())) {
                    ...
                    if (!(itemstack.getItem() instanceof ItemEnderPearl) && AntiThrowBlock.ticks > 0) {
                        break;
                    }
        ...
        while (Keyboard.next()) {
            ...
            if (flag) {
                ...
                if (this.currentScreen == null) {
                    ...
                    Expensive.getInstance().keyTyped(i);
    ...
    private void runTickMouse() throws IOException {
        while (Mouse.next()) {
            ...
            if (Mouse.getEventButtonState()) {
                EventMouseTick eventMouse = new EventMouseTick(i);
