...
public class RenderManager
{
    ...
    public boolean renderEntityStaticNoShadow(Entity entity, float partialTicks, boolean hideDebugBox)
    {
        ...
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        return this.doRenderEntityNoShadow(entity, d0 - this.renderPosX, d1 - this.renderPosY, d2 - this.renderPosZ, f, partialTicks, hideDebugBox);
    }
            ...
            if (render != null && this.renderEngine != null) {
                try {
                    if (render instanceof RenderLivingBase) {
                        ((RenderLivingBase) render).setRenderOutlines(this.renderOutlines);
                    }
