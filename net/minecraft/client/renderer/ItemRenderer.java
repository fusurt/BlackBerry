...
import wtf.expensive.modules.impl.render.SwingAnimationModule;
...
public class ItemRenderer {
    ...
    private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_) {
        ...
        GlStateManager.translate((float) i * 0.56f, -0.52f + p_187459_2_ * (Expensive.getInstance().getModuleManager().get(SwingAnimationModule.class).state ? -0.0f : -0.6f), -0.72f);
    }
    ...
    public void renderItemInFirstPerson(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, ItemStack p_187457_6_, float p_187457_7_) {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_)) {
            ...
            if (p_187457_6_.isEmpty()) {
                ...
                if (Expensive.getInstance().getModuleManager().get(SwingAnimationModule.class).state) {
                    if (flag1) {
                        GL11.glTranslatef(SwingAnimationModule.right_x.get(),
                                SwingAnimationModule.right_y.get(), SwingAnimationModule.right_z.get());
                    } else {
                        GL11.glTranslatef(SwingAnimationModule.left_x.get(),
                                SwingAnimationModule.left_y.get(), SwingAnimationModule.left_z.get());
                    }
                }
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
                    ...
                    if (enumhandside == EnumHandSide.RIGHT) {
                        float anim = (float) Math.sin(p_187457_5_ * (Math.PI / 2) * 2);
                        if (SwingAnimationModule.swordAnim.get().equalsIgnoreCase("Self")
                                && Expensive.getInstance().getModuleManager().get(SwingAnimationModule.class).state) {
                            GL11.glRotated(90, 0, 1, 0);
                            GL11.glRotated(-60, 0, 0, 1);
                            GL11.glRotated(-SwingAnimationModule.angle.get() - (SwingAnimationModule.swipePower.get() * 10) * anim, 1, 0, 0);
                        } else if (SwingAnimationModule.swordAnim.get().equalsIgnoreCase("Block")
                                && Expensive.getInstance().getModuleManager().get(SwingAnimationModule.class).state) {
                            GL11.glRotated(90, 0, 1, 0);
    ...
    private void renderFireInFirstPerson() {
        if (Expensive.getInstance().getModuleManager().get(NoRenderModule.class).state) {
            ...
            EventOverlay eventOverlay = new EventOverlay(EventOverlay.OverlayType.Fire);
            EventManager.dispatchEvent(eventOverlay);
