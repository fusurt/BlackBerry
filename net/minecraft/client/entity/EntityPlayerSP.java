...
import wtf.expensive.event.impl.player.EventAction;
...
import wtf.expensive.modules.impl.movement.NoSlowModule;
import wtf.expensive.modules.impl.movement.TimerModule;
import wtf.expensive.modules.impl.player.NoPush;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    private void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            EventMotion eventPre = new EventMotion(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
            EventManager.dispatchEvent(eventPre);
            ...
            if (this.isRiding()) {
                ...
                this.connection.sendPacket(new CPacketPlayer.PositionRotation(eventPre.getX(), eventPre.getY(), eventPre.getZ(), eventPre.getYaw(), eventPre.getPitch(), eventPre.isOnGround()));
                var++;
            } else if (flag2) {
                this.connection.sendPacket(new CPacketPlayer.Position(eventPre.getX(), eventPre.getY(), eventPre.getZ(), eventPre.isOnGround()));
                var++;
            } else if (flag3) {
    ...
    protected boolean pushOutOfBlocks(double x, double y, double z) {
        if (Expensive.getInstance().getModuleManager().get(NoPush.class).state) return false;
        if (this.noClip) {
            return false;
        } else {
    ...
    public void onLivingUpdate() {
        ...
        if (this.isHandActive() && !this.isRiding()) {
            if (!Expensive.getInstance().getModuleManager().get(NoSlowModule.class).state) {
    ...
    public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
        EventPreMove epm = new EventPreMove(p_70091_2_, p_70091_4_, p_70091_6_);
        EventManager.dispatchEvent(epm);
        double d0 = this.posX;
        double d1 = this.posZ;
        super.moveEntity(x, epm.getX(), epm.getY(), epm.getZ());
