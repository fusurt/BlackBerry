...
import wtf.expensive.event.impl.player.EventEntityMove;
...
public abstract class World implements IBlockAccess {
    ...
    public boolean func_191504_a(@Nullable Entity p_191504_1_, AxisAlignedBB p_191504_2_, boolean p_191504_3_, @Nullable List<AxisAlignedBB> p_191504_4_) {
    ...
    public void updateEntityWithOptionalForce(Entity entityIn, boolean forceUpdate) {
        ...
        if (forceUpdate && entityIn.addedToChunk) {
            ...
            if (entityIn.isRiding()) {
                ...
                if (prevPosX != entityIn.posX || prevPosY != entityIn.posY || prevPosZ != entityIn.posZ) {
                    ...
                    EventManager.dispatchEvent(eem);
                }
        ...
        if (!entityIn.addedToChunk || entityIn.chunkCoordX != i3 || entityIn.chunkCoordY != j3
                || entityIn.chunkCoordZ != k3) {
            if (entityIn.addedToChunk && this.isChunkLoaded(entityIn.chunkCoordX, entityIn.chunkCoordZ, true)) {
                this.getChunkFromChunkCoords(entityIn.chunkCoordX, entityIn.chunkCoordZ).removeEntityAtIndex(entityIn,
                        entityIn.chunkCoordY);
            }
    ...
    public List<AxisAlignedBB> getCollisionBoxes2(@Nullable Entity entityIn, AxisAlignedBB aabb) {
        List<AxisAlignedBB> list = Lists.<AxisAlignedBB>newArrayList();
        this.func_191504_a2(entityIn, aabb, false, list);
        return list;
    }
    private boolean func_191504_a2(@Nullable Entity p_191504_1_, AxisAlignedBB p_191504_2_, boolean p_191504_3_,
                                   @Nullable List<AxisAlignedBB> p_191504_4_) {
        int i = MathHelper.floor(p_191504_2_.minX) - 1;
        int j = MathHelper.ceil(p_191504_2_.maxX) + 1;
        int k = MathHelper.floor(p_191504_2_.minY) - 1;
        int l = MathHelper.ceil(p_191504_2_.maxY) + 1;
                        ...
                        for (int i2 = k; i2 < l; ++i2) {
                            if (!flag2 && !flag3 || i2 != l - 1) {
                                ...
                                if (!(iblockstate1.getMaterial() == Material.WATER))
                                    iblockstate1.addCollisionBoxToList(this, blockpos$pooledmutableblockpos,
                                            p_191504_2_, p_191504_4_, p_191504_1_, false);
    ...
    public boolean checkLightFor(EnumSkyBlock lightType, BlockPos pos) {
            EventOverlay event = new EventOverlay(EventOverlay.OverlayType.Light);
            EventManager.dispatchEvent(event);

            if (event.isCancelled() && lightType == EnumSkyBlock.SKY) {
                return false;
            }
