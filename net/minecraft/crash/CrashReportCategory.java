...
public class CrashReportCategory
{
    ...
    public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2)
    {
        if (this.stackTrace.length != 0 && s1 != null)
        {
            ...
            if (stacktraceelement.isNativeMethod() == s1.isNativeMethod() && stacktraceelement.getClassName().equals(s1.getClassName()) && kek(stacktraceelement).equals(kek(s1)) && stacktraceelement.getMethodName().equals(s1.getMethodName()))
            {
    ...
    public static String kek(StackTraceElement instance) {
