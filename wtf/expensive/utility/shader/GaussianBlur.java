...
import wtf.expensive.utility.shader.wtf.shader.kernel.GaussianKernel;
...
public class GaussianBlur {
    ...
    public static ShaderUtility blurShader = new ShaderUtility("expensive/shaders/gaussian.frag");
    ...
    private static void drawBlur(float radius, Runnable data) {
